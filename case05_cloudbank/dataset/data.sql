/* 
=========================================================
 Case Study: Cloud Bank – Digital Banking & Cloud Storage
=========================================================

Schema Name   : cloud_bank
Description   : 
Cloud Bank is a futuristic digital bank that integrates 
traditional banking services with cloud storage allocation. 

Objective:
This dataset simulates customers, regions, and transactions 
to analyze customer behavior, financial activity, and 
...
2. customer_nodes
   ...
   - region_id   : Region allocation of the customer
   - node_id     : Node allocation (server/data node)
   - start_date  : Date when allocation started
   - end_date    : Date when allocation ended

3. customer_transactions
   - customer_id : Customer performing transaction
   - txn_date    : Date of transaction
   - txn_type    : Type (deposit, withdrawal, purchase)
