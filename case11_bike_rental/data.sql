-- Case Study: Bike_Rental
-- Schema Name: bike_rental
-- Description: This SQL script creates a database for a bike rental shop to analyze customer rentals, bike inventory, and membership data for business insights.
-- Created: September 29, 2025

-- Table: customer
-- Description: In the first table, customer, you'll find details about the customers of the bike rental shop.
-- Columns:
...
-- Table: bike
-- Description: In the bike table, you'll find information about bikes the rental shop owns.
-- Columns:
...
-- Table: rental
-- Description: The rental table matches customers with bikes they have rented.
-- Columns:
...
-- Description: The membership_type table has information about the different membership types for purchase.
-- Columns:
...
-- Table: membership
-- Description: The membership table has information about individual memberships purchased by customers.
-- Columns:
